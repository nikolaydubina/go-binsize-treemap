docs: 
	...
	cat testdata/cockroach-v21.1-geb1aa69bc4.symtab | ./go-binsize-treemap -csv > docs/cockroach-v21.1-geb1aa69bc4.csv
	...
	cat testdata/cockroach-v21.1-geb1aa69bc4.symtab | ./go-binsize-treemap > docs/cockroach-v21.1-geb1aa69bc4.svg
	cat testdata/cockroach-v21.1-geb1aa69bc4.symtab | ./go-binsize-treemap -w 4096 -h 4096 > docs/cockroach-v21.1-geb1aa69bc4-4096x4096.svg
	...
	cat testdata/hugo.symtab | ./go-binsize-treemap  -w 16384 -h 16384 -symbols > docs/hugo-16384x16384-symbols.svg
